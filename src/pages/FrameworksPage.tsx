...
const agreements = [
  {
    ...
    description:
      "Define terms between employer and employee, including role, compensation, and confidentiality.",
    icon: Briefcase,
  },
  {
    ...
    description:
      "Protect confidential information shared between parties during business discussions.",
    icon: ShieldCheck,
  },
  {
    ...
    description:
      "Standard lease contract between landlord and tenant covering rent, duration, and terms.",
    icon: Home,
  },
  {
    ...
    description:
      "Set scope, deliverables, and payment terms between a freelancer and a client.",
    icon: Pencil,
  },
  {
    ...
    description:
      "Outline services provided, timelines, and obligations between provider and client.",
    icon: Handshake,
  },
  {
    ...
    description:
      "Establish roles, profit sharing, and responsibilities between business partners.",
    icon: Users2,
  },
];
      ...
      <Card className="rounded-2xl shadow-sm">
        <CardContent className="p-8 space-y-4">
          ...
          <div className="rounded-xl border border-dashed border-border p-6 text-sm text-muted-foreground bg-muted/30">
            Template preview and download will be available here.
            Connect your backend to load the full document.
          </div>
        </CardContent>
      </Card>
    </div>
