        ...
        <form onSubmit={handleLogin}>
          <CardContent className="space-y-6 px-10">
            <div className="space-y-2">
              <Label
                htmlFor="email"
                className="text-white/60 font-black text-[10px] uppercase tracking-widest ml-1"
              >
                Identity
              </Label>
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-14 pl-12 bg-white/5 border-white/10 text-white placeholder:text-white/20 focus:border-saffron/40 focus:ring-0 rounded-2xl transition-all"
                />
              </div>
            </div>
          ...
          <CardFooter className="flex flex-col gap-6 p-10 pt-8">
            <Button
              type="submit"
              className="w-full h-14 gap-3 shadow-2xl shadow-saffron/10 hover:shadow-saffron/30 hover:-translate-y-1 transition-all rounded-2xl font-black bg-white text-navy hover:bg-saffron hover:text-navy"
              disabled={loading}
            >
              {loading
                ? "Decrypting..."
