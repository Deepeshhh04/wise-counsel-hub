...
const agreements = [
  {
    ...
    description:
      "Standard agreement for renting a residential property between a landlord and tenant.",
    category: "Property",
    icon: Home,
    color: "bg-blue-500/10 text-blue-600",
    file: "/agreements/rental.pdf",
  },

  {
    ...
    description:
      "Agreement outlining terms and conditions between an employer and an employee.",
    category: "Corporate",
    icon: Briefcase,
    color: "bg-purple-500/10 text-purple-600",
    file: "/agreements/employment.pdf",
  },

  {
    ...
    description:
      "Legal contract to protect confidential information shared between parties.",
    category: "Corporate",
    icon: ShieldCheck,
    ...
    <PageTransition className="p-4 md:p-6 space-y-8 max-w-6xl mx-auto min-h-[calc(100vh-4rem)]">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary/10 via-card to-accent/10 p-8 border border-primary/20 shadow-sm">
        ...
        <p className="text-muted-foreground relative z-10 text-lg">
          Browse and download legally valid agreement templates
        </p>
      </div>
              ...
              <CardFooter className="flex gap-3 pt-0">
                ...
                {agreement.file ? (
                  ...
                  >
                    <Button
                      size="sm"
                      className="w-full gap-2 shadow-md hover:shadow-primary/20"
                    >
      ...
      <div className="bg-muted/30 rounded-2xl p-8 text-center border border-dashed border-border/60">
        ...
        <p className="text-muted-foreground text-sm mt-1 max-w-md mx-auto">
          Our verified lawyers can help you draft a personalized legal agreement tailored to your specific needs.
        </p>

        <Button
          variant="link"
          className="mt-4 gap-1 text-primary font-semibold"
          asChild
        >
          <a href="/lawyers">
