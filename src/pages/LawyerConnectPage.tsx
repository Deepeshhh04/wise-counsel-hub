    ...
    <PageTransition className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto min-h-[calc(100vh-4rem)] relative">
      ...
      <div className="relative overflow-hidden rounded-3xl">
        ...
        <div className="relative z-10 space-y-4 max-w-2xl">
          <Badge className="bg-saffron text-white border-none px-3 py-1 mb-2">
          ...
          <p className="text-[#0B1C3F] text-base md:text-lg">
            Access India's premier network of
      ...
      >
        ...
        <div className="flex flex-wrap gap-3">
          ...
          >
            <SelectTrigger className="w-[140px] h-12 rounded-xl bg-white border border-[#D6D3D1] text-[#0B1C3F]">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-12 w-12 rounded-xl hover:bg-primary/5"
            onClick={() => {
              setSearch("");
              setSelectedState("");
              setSelectedCity("");
