const legalDataset = [
...

  {
    ...
    keywords: ["cheque", "bounce", "dishonour", "check", "returned cheque", "insufficient funds"],
    language_hints: ["cheque bounce", "cheque dishonour", "cheque wapas"],
    answer:
  ...
  },
  {
    ...
    keywords: ["theft", "stealing", "stolen", "stole", "chori", "rob", "snatch"],
    language_hints: ["chori", "chhina-jhopatni", "loot"],
    answer:
  ...
  },
  {
    ...
    keywords: ["FIR", "first information report", "police complaint", "police report", "case register"],
    language_hints: ["prathamik soochna report", "shikayat", "complaint"],
    answer:
  ...
  },
  {
    ...
    keywords: ["arrest", "arrested", "police custody", "detention", "rights on arrest", "bail"],
    language_hints: ["giraftari", "pakadhna", "hathkadi"],
    answer:
  ...
  },
  {
    ...
    keywords: ["murder", "homicide", "kill", "killing", "death", "culpable homicide", "hatya"],
    language_hints: ["hatya", "qatl", "khoon"],
    answer:
  ...
  },
  {
    ...
    keywords: ["sexual harassment", "workplace harassment", "POSH", "misconduct", "hostile work environment"],
    language_hints: ["youn utteedan", "karya sthal par utteedan"],
    answer:
  ...
  },
  {
    ...
    keywords: ["domestic violence", "wife beating", "husband abuse", "family violence", "marital abuse", "gharelu hinsa"],
    language_hints: ["gharelu hinsa", "patni par atyachar", "parivaarik hinsa"],
    answer:
  ...
  },
  {
    ...
    keywords: ["cybercrime", "hacking", "online fraud", "cyber fraud", "data theft", "phishing", "cyber attack"],
    language_hints: ["saibhar apraadh", "online thagee"],
    answer:
...

  {
    ...
    keywords: ["divorce", "separation", "marriage dissolution", "talaq", "talaak", "vivah viched"],
    language_hints: ["talaq", "talaak", "vivah viched", "alag hona"],
    answer:
      "Grounds for divorce vary by religion. Under the Hindu Marriage Act, 1955 (applicable to Hindus, Sikhs, Jains, Buddhists), grounds include cruelty, adultery, desertion for 2 years, conversion to another religion, mental disorder, leprosy, venereal disease, renunciation of the world, and presumption of death. Mutual consent divorce is also available under Section 13B after 1 year of separation. For Muslims, divorce is governed by Muslim Personal Law; for Christians, by the Indian Divorce Act, 1869; for Parsis, by the Parsi Marriage and Divorce Act, 1936.",
  ...
  },
  {
    ...
    keywords: ["child custody", "custody", "children", "guardianship", "parenting rights", "bacche ki custody"],
    language_hints: ["bacche ki custody", "bachche ki dekhbhal", "palak"],
    answer:
      "In India, child custody is governed by the Guardians and Wards Act, 1890 and personal laws. Courts decide custody based on the 'best interest of the child' principle. Types of custody include physical custody, legal custody, joint custody, and sole custody. Courts consider factors such as the child's age (children below 5 generally stay with the mother), the financial capacity of parents, the child's preference (if old enough), and the moral character of the parents.",
  ...
  },
  {
    ...
    keywords: ["maintenance", "alimony", "support", "nafaqa", "bharan poshan", "wife support"],
    language_hints: ["nafaqa", "bharan poshan", "guzara", "nafqa"],
    answer:
      "Under Section 125 of the CrPC, any person who has sufficient means and neglects to maintain their wife, children, or parents can be ordered to pay monthly maintenance by a Magistrate. For divorced Muslim women, the Muslim Women (Protection of Rights on Divorce) Act, 1986 applies. Under the Hindu Adoption and Maintenance Act, 1956, a Hindu wife is entitled to maintenance from her husband. The amount is determined by the court based on the income of the husband and needs of the wife/children.",
  ...
  },
  {
    ...
    keywords: ["marriage", "wedding", "nikah", "vivah", "shaadi", "registration", "marriage requirements"],
    language_hints: ["shaadi", "vivah", "nikah", "byah", "marriage registration"],
    answer:
      "Under the Hindu Marriage Act, 1955, a valid Hindu marriage requires: neither party to have a living spouse; neither party to be of unsound mind; the groom to be at least 21 and the bride at least 18 years of age; and the parties must not be within prohibited degrees of relationship. Marriage registration is compulsory in most states. The Special Marriage Act, 1954 allows for inter-religion marriages. Muslim marriages (Nikah) require offer and acceptance, witnesses, and mehr.",
...

  {
    ...
    keywords: ["property registration", "sale deed", "registry", "land registration", "stamp duty", "zameen registry"],
    language_hints: ["zameen registry", "sampatti panjikaran", "dastavej"],
    answer:
      "Property registration in India is governed by the Registration Act, 1908. The process involves: (1) getting the sale deed drafted on stamp paper of appropriate value; (2) paying stamp duty as per state rates; (3) visiting the Sub-Registrar's office with both buyer and seller; (4) providing identity proof, property documents, and two witnesses; (5) biometric verification and photograph. Failure to register a property document makes it inadmissible as evidence. Registration must be done within 4 months of execution.",
...

  {
    ...
    keywords: ["gratuity", "retirement benefit", "service benefit", "gratuity payment", "employee benefit"],
    language_hints: ["upardan", "seva nidhi", "sewa labh"],
    answer:
      "Under the Payment of Gratuity Act, 1972, an employee is entitled to gratuity after completing 5 years of continuous service. It is payable on retirement, resignation, superannuation, death, or disablement. Gratuity is calculated as: (Last drawn salary × 15/26 × Number of years of service). The maximum gratuity amount is Rs. 20 lakhs. The employer must pay gratuity within 30 days of it becoming payable. Non-payment can attract imprisonment up to 2 years.",
  ...
  },
  {
    ...
    keywords: ["termination", "fired", "dismissed", "retrenchment", "layoff", "naukri jaana", "job loss"],
    language_hints: ["naukri se nikalna", "naukri chhodna", "job se barkhast"],
    answer:
      "Termination of employment is governed by the Industrial Disputes Act, 1947, and state-specific Shops and Establishments Acts. For workmen in industries with 100+ employees, prior government permission is required for retrenchment. A notice period of 30 days (or pay in lieu) must be given. Retrenchment compensation of 15 days' average pay for every completed year of service is mandatory. Wrongful termination can be challenged before the Labour Court. Individual employment contracts may also provide additional protections.",
  ...
  },
  {
    ...
    keywords: ["minimum wage", "salary", "pay", "wages", "nyuntam vetan", "remuneration"],
    language_hints: ["nyuntam vetan", "minimum tankhwah", "kam se kam mazdoori"],
    answer:
      "The Minimum Wages Act, 1948 requires employers to pay workers not less than the minimum wage fixed by the Central or State Government for scheduled employments. Minimum wages vary by state, industry, and skill category. The Code on Wages, 2019 (not yet fully notified) seeks to consolidate wage-related laws. Failure to pay minimum wages is a criminal offence punishable with imprisonment up to 5 years and/or fine. Workers can file complaints with the Labour Commissioner.",
  ...
  },
  {
    ...
    keywords: ["maternity leave", "pregnancy leave", "maternity benefit", "motherhood leave"],
    language_hints: ["prasooti chhutti", "matritva labh", "garbhavastha chhutti"],
    answer:
      "Under the Maternity Benefit (Amendment) Act, 2017, women employed in establishments with 10 or more employees are entitled to 26 weeks of paid maternity leave for the first two children (12 weeks for the third child). Maternity benefit is payable at the rate of the average daily wage. The employer cannot dismiss or discharge a woman during maternity leave. Nursing breaks of 2 per day until the child is 15 months old are also mandated. Establishments with 50+ employees must provide creche facilities.",
...

  {
    ...
    keywords: ["consumer complaint", "consumer forum", "defective product", "service deficiency", "consumer court", "refund"],
    language_hints: ["upbhokta shikaayat", "upbhokta forum", "grahak seva"],
    answer:
      "Under the Consumer Protection Act, 2019, a consumer can file a complaint for defective goods, deficiency in services, unfair trade practices, or overcharging. Complaints can be filed at: District Consumer Commission (claims up to Rs. 1 crore), State Consumer Commission (Rs. 1 crore to Rs. 10 crore), or National Consumer Disputes Redressal Commission (above Rs. 10 crore). Complaints can also be filed online at consumerhelpline.gov.in or the INGRAM portal. The complaint must be filed within 2 years of the cause of action.",
  ...
  },
  {
    ...
    keywords: ["consumer rights", "buyer rights", "product warranty", "right to information", "consumer protection"],
    language_hints: ["upbhokta adhikar", "grahak ke adhikar"],
    answer:
      "The Consumer Protection Act, 2019 recognizes six consumer rights: (1) Right to Safety – protection from hazardous goods/services; (2) Right to Information – about quality, quantity, and price; (3) Right to Choose – access to competitive prices; (4) Right to be Heard – representation in consumer forums; (5) Right to Redress – compensation for defective goods or services; (6) Right to Consumer Education. The Act also establishes the Central Consumer Protection Authority (CCPA) to regulate and investigate consumer complaints.",
...

  {
    ...
    keywords: ["fundamental rights", "constitutional rights", "basic rights", "maulik adhikar", "civil liberties"],
    language_hints: ["maulik adhikar", "samvidhanik adhikar", "bunyadi haq"],
    answer:
      "Part III of the Indian Constitution (Articles 12–35) guarantees six fundamental rights: (1) Right to Equality (Articles 14–18) – equality before law, prohibition of discrimination; (2) Right to Freedom (Articles 19–22) – freedom of speech, movement, profession, and personal liberty; (3) Right against Exploitation (Articles 23–24) – ban on human trafficking and child labour; (4) Right to Freedom of Religion (Articles 25–28); (5) Cultural and Educational Rights (Articles 29–30); (6) Right to Constitutional Remedies (Article 32) – the right to move the Supreme Court for enforcement of fundamental rights.",
  ...
  },
  {
    ...
    keywords: ["writ petition", "habeas corpus", "mandamus", "certiorari", "quo warranto", "prohibition writ"],
    language_hints: ["rit yaachika", "habeas corpus", "mandamus"],
    answer:
      "A writ petition is a legal remedy available under Article 32 (Supreme Court) or Article 226 (High Courts) to enforce fundamental rights or for any other purpose. The five types of writs are: (1) Habeas Corpus – to produce a detained person before the court; (2) Mandamus – to compel a public authority to perform its duty; (3) Prohibition – to stop a lower court from exceeding its jurisdiction; (4) Certiorari – to quash an order of a lower court/tribunal; (5) Quo Warranto – to challenge a person's right to hold a public office. High Courts have broader writ jurisdiction than the Supreme Court.",
...

  {
    ...
    keywords: ["road accident", "car accident", "motor accident", "vehicle collision", "accident claim", "durghatna"],
    language_hints: ["sadak durghatna", "car accident", "motor durghatna", "gaadi ki takkar"],
    answer:
      "After a road accident in India: (1) Call police (100) and ambulance (108) immediately; (2) An FIR should be registered under Section 279/304A/338 IPC depending on severity; (3) For insurance claims, notify the insurer within the stipulated time; (4) Victims can claim compensation from the Motor Accident Claims Tribunal (MACT) under the Motor Vehicles Act, 1988; (5) In hit-and-run cases, compensation up to Rs. 2 lakh for death and Rs. 50,000 for grievous injury is available from the Solatium Fund. Third-party insurance is mandatory for all vehicles.",
...

  {
    ...
    keywords: ["RERA", "real estate", "home buyer", "flat buyer", "builder", "property delay", "property complaint"],
    language_hints: ["griha khariddar", "flat kharidna", "builder complaint", "sampatti vivad"],
    answer:
      "The Real Estate (Regulation and Development) Act, 2016 (RERA) protects home buyers. Key rights include: (1) builders must register projects with the state RERA authority; (2) 70% of buyer funds must be kept in an escrow account for construction; (3) buyers can get a refund with interest if the builder delays possession; (4) the builder cannot make changes to the plan without buyer consent; (5) buyers are entitled to all promised amenities. Complaints can be filed on the state RERA portal. The adjudicating officer can award compensation for losses.",
...

  {
    ...
    keywords: ["RTI", "right to information", "government information", "RTI application", "public information"],
    language_hints: ["soochna ka adhikar", "RTI aavedan", "sarkari soochna"],
    answer:
      "Under the Right to Information Act, 2005, any citizen can request information from a public authority. Steps: (1) Write an application in English, Hindi, or local official language to the Public Information Officer (PIO) of the concerned department; (2) Pay a fee of Rs. 10 (for Central Government); (3) The PIO must reply within 30 days (48 hours for life/liberty matters); (4) If denied or not satisfied, file a first appeal to the Appellate Authority within 30 days; (5) Further appeal can be made to the Central/State Information Commission. RTI can also be filed online at rtionline.gov.in.",
  ...
  },
  {
    ...
    keywords: ["will", "testament", "last will", "legal will", "vasiyat", "succession", "inheritance document"],
    language_hints: ["vasiyat", "wasiyatnama", "antim icha"],
    answer:
      "Under the Indian Succession Act, 1925, a valid will must: (1) be in writing; (2) be signed by the testator (the person making the will); (3) be signed or acknowledged in the presence of at least two witnesses; (4) the witnesses must also sign the will in the presence of the testator. A will does not need to be registered, but registration provides stronger legal protection. For Hindus, Sikhs, Jains, and Buddhists, the Hindu Succession Act applies. Muslims can distribute only up to one-third of their estate by will; the rest follows personal law.",
